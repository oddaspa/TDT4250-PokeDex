...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Kingdom</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link domain.impl.KingdomImpl#getPhyla <em>Phyla</em>}</li>
...
public class KingdomImpl extends MinimalEObjectImpl.Container implements Kingdom {
	/**
	 * The cached value of the '{@link #getPhyla() <em>Phyla</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getPhyla()
	 * @generated
	...
	protected EClass eStaticClass() {
		return DomainPackage.Literals.KINGDOM;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.KINGDOM__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DomainPackage.KINGDOM__PHYLA:
				return ((InternalEList<?>)getPhyla()).basicRemove(otherEnd, msgs);
		}
